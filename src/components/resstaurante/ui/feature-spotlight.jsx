...
export function FeaturedSpotlight({ id }) {
  ...
  return (
    <div
      ...
      {/* Left: Text Block */}
      <div
        className="relative z-10 flex w-full max-w-[320px] shrink-0 flex-col items-center text-center md:w-[240px] md:items-start md:text-left lg:w-[280px] lg:pt-4">
        ...
        <h2 className="relative">
          ...
          <span
            className="block text-4xl font-normal tracking-tight text-red-700 transition-all duration-700 sm:text-5xl md:text-5xl lg:text-6xl"
            style={{
              transform: isHovered ? "translateX(12px)" : "translateX(0)",
              transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)",
            }}>
              {resstauranteFind ? resstauranteFind.name : 'Testo'}
          </span>
        </h2>
        ...
        <p
          ...
          {resstauranteFind ? resstauranteFind.descriptionRess : 'Test architecture meets the natural world.'}
        </p>

        {/* Minimal CTA - responsive spacing */}
        <div className="mt-6 flex items-center gap-4 md:mt-8 lg:mt-10" onClick={handleDown}>
          <div
            ...
            style={{
              borderColor: isHovered ? "oklch(50.5% 0.213 27.518)" : "hsl(var(--muted-foreground) / 0.3)",
              backgroundColor: isHovered ? "hsl(var(--foreground))" : "transparent",
              color: isHovered ? "oklch(79.5% 0.184 86.047)" : "hsl(var(--foreground))",
          ...
          <span
            ...
            style={{
              color: isHovered ? "oklch(50.5% 0.213 27.518)" : "hsl(var(--foreground))",
      ...
      <div
        ...
        <div
          ...
          style={{
            borderColor: isHovered ? "oklch(50.5% 0.213 27.518)" : "transparent",
        ...
        <div
          className="relative h-[280px] w-[260px] overflow-hidden sm:h-[320px] sm:w-[300px] md:h-[360px] md:w-[320px] lg:h-[420px] lg:w-[380px]">
          <div
          ...
          <img
            src={resstauranteFind ? resstauranteFind.imgSrc : '/images/resstaurantes/ress/ress-1.jpg'}
          ...
          {/* Corner accents */}
          <div
            className="absolute left-2 top-2 h-5 w-px bg-[oklch(82.8%_0.189_84.429)] transition-all duration-500 md:left-3 md:top-3 md:h-6"
            style={{
              opacity: isHovered ? 1 : 0,
          ...
          <div
            className="absolute left-2 top-2 h-px w-5 bg-[oklch(82.8%_0.189_84.429)] transition-all duration-500 md:left-3 md:top-3 md:w-6"
            style={{
              opacity: isHovered ? 1 : 0,
          ...
          <div
            className="absolute bottom-2 right-2 h-5 w-px bg-[oklch(82.8%_0.189_84.429)] transition-all duration-500 md:bottom-3 md:right-3 md:h-6"
            style={{
              opacity: isHovered ? 1 : 0,
              transform: isHovered ? "scaleY(1)" : "scaleY(0)",
          ...
          <div
            className="absolute bottom-2 right-2 h-px w-5 bg-[oklch(82.8%_0.189_84.429)] transition-all duration-500 md:bottom-3 md:right-3 md:w-6"
            style={{
              opacity: isHovered ? 1 : 0,
              transform: isHovered ? "scaleX(1)" : "scaleX(0)",
