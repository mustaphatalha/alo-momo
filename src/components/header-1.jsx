...
export function Header() {
	...
	return (
        <header
            className={cn('fixed pt-[23px] top-0 z-50 w-full border-b border-transparent', {
...
//   </svg>
		<img src="./icones/logo.png" alt="Alo Momo" {...props} className='w-[100px]' />
);
