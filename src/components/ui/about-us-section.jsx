...
export default function AboutUsSection() {
  ...
  return (
    <section
      ...
      <motion.div
        className="absolute top-1/2 left-1/4 w-4 h-4 rounded-full bg-[red]/30"
        animate={{
          y: [0, -15, 0],
          opacity: [0.5, 1, 0.5],
        }}
      ...
      <motion.div
        ...
        <motion.div className="flex flex-col items-center mb-6" variants={itemVariants}>
          <motion.span
            className="text-[gray] font-medium mb-2 flex items-center gap-2"
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4 text-center text-[red]">Services</h2>
          <motion.div
            className="w-24 h-1 bg-[yellow]"
            initial={{ width: 0 }}
            animate={{ width: 96 }}
            ...
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              <motion.div
                ...
                <motion.div
                  ...
                  <motion.button
                    className="bg-white text-[red] px-4 py-2 rounded-full flex items-center gap-2 text-sm font-medium"
              ...
              <motion.div
                className="absolute inset-0 border-4 border-[yellow] rounded-md -m-3 z-[-1]"
              ...
              <motion.div
                className="absolute -top-4 -right-8 w-16 h-16 rounded-full bg-[red]/10"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.9 }}
                style={{ y: y1 }}></motion.div>
              <motion.div
                className="absolute -bottom-6 -left-10 w-20 h-20 rounded-full bg-[red]/15"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                className="absolute -top-10 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[red]"
                animate={{
                  y: [0, -10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
              ...
              <motion.div
                className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-[red]"
                animate={{
                  y: [0, 10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
        ...
        <motion.div
          ...
          <motion.button
            className="bg-[yellow] hover:bg-[red]/90 text-black px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}>
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <motion.div
          className="text-[yellow] bg-[red]/10 p-3 rounded-lg transition-colors duration-300 group-hover:bg-[red]/20 relative"
          whileHover={{ rotate: [0, -10, 10, -5, 0], transition: { duration: 0.5 } }}>
          {icon}
          {secondaryIcon}
        </motion.div>
        <h3
          className="text-xl font-medium text-[#202e44] group-hover:text-[red] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
...
function StatCounter({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5, transition: { duration: 0.2 } }}>
      <motion.div
        className="w-14 h-14 rounded-full bg-[red]/5 flex items-center justify-center mb-4 text-[yellow] group-hover:bg-[#88734C]/10 transition-colors duration-300"
      ...
      <motion.div
        className="w-10 h-0.5 bg-[red] mt-3 group-hover:w-16 transition-all duration-300" />
    </motion.div>
  );
}
